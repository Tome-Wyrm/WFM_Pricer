// src/vendor/lua.rs
//! Minimal Lua-subset tokenizer/parser used to read `Module:Vendors/data` off the
//! Warframe wiki (a plain Lua table literal, not a general Lua program).
...
pub(crate) fn parse_rank_list(table: &[(Option<LuaKey>, LuaValue)]) -> RankList {
